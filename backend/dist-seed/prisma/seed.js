...
async function seedDemoData() {
    ...
    if (!demoPassword) {
        console.log("Skipping demo user seed — set DEMO_USER_PASSWORD to create demo account.");
        return;
    }
    ...
    const organization = await prisma.organization.upsert({
        ...
        create: {
            ...
            members: {
                create: {
                    userId: demoUser.id,
                    role: generated_1.Role.OWNER,
                    status: generated_1.Status.ACTIVE,
                    joinedAt: new Date(),
                },
            },
        },
    ...
    const project = await prisma.project.upsert({
        ...
        create: {
            ...
            status: generated_1.ProjectStatus.ACTIVE,
            collaborators: {
                create: {
                    userId: demoUser.id,
                    role: generated_1.ProjectRole.OWNER,
                    status: generated_1.Status.ACTIVE,
                    addedAt: new Date(),
                },
            },
